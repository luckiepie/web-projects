...
<%
	...
	FileInputStream fis = new FileInputStream("d:\\suhyeon_com_class\\upload\\"+fileName);
	...
	// 파일 작성.txt => 공백이 파일명에 있으면 인코딩 시킬 때 +로 변경이 일어남(공백 상태로 처리)
	...
	// 언더바 찾고 그 뒤에서부터 찾아서 잘라내기 -> substring
